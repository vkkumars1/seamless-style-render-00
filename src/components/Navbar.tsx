      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link 
              to="/get-started" 
              className="bg-cloudbox-blue hover:bg-cloudbox-darkBlue text-white px-4 py-2 rounded-md transition-colors"
            >
              Get started
            </Link>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 right-0 bg-white shadow-lg py-4 px-6 animate-fadeIn">
          <div className="flex flex-col space-y-4">
            <Link 
              to="/features" 
              className="text-gray-600 hover:text-cloudbox-blue transition-colors py-2"
            ...
            <div className="pt-4 border-t border-gray-100 flex flex-col space-y-3">
              <Link 
                to="/signin" 
                className="text-gray-700 hover:text-cloudbox-blue transition-colors py-2"
                onClick={() => setMobileMenuOpen(false)}
              >
                Sign in
              </Link>
              <Link 
                to="/get-started" 
                className="bg-cloudbox-blue hover:bg-cloudbox-darkBlue text-white px-4 py-2 rounded-md transition-colors text-center"
                onClick={() => setMobileMenuOpen(false)}
              >
                Get started
              </Link>
